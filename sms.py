    ...
    def Dsmartgo(self):
        ...
        for numara in liste:
            ...
            try:
                ...
                print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> dsmartgo.com.tr "+Fore.LIGHTRED_EX+numara)

            except AttributeError:

                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> dsmartgo.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if kigili.status_code == 202:
                         ...
                         print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> kigili.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                     ...
                     print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> kigili.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> core.kahvedunyasi.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> core.kahvedunyasi.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if naosstars.status_code == 202:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> shop.naosstars.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> shop.naosstars.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if wmf.status_code == 202:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> wmf.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> wmf.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> prod.fasapi.net "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> prod.fasapi.net "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if bim.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> bim.veesk.net "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> bim.veesk.net "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if len(r.json()["meta"]["messages"]["success"]) != 0:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> api.ceptesok.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> api.ceptesok.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if tiklagelsin.json()["data"]["generateOtp"] == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> svc.apps.tiklagelsin.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> svc.apps.tiklagelsin.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.status_code) == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> a101.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> a101.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if home.status_code == 202:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> englishhome.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> englishhome.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if su.json()["status"] == "ok":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> sakasu.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> sakasu.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if rentiva.json()["success"] == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> rentiva.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> rentiva.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if bineq.json()["IsSuccess"] == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> bineqapi.heymobility.tech "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> bineqapi.heymobility.tech "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if link.json()["detail"] == "Ok":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> consumer-auth.linkfleet.de "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> consumer-auth.linkfleet.de "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if lonca.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> loncamarket.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> loncamarket.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if dgn.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> odeme.dgnonline.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> odeme.dgnonline.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 204:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> api.yaanimail.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> api.yaanimail.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.json()["Data"]["IsSMSSend"] == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> defacto.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> defacto.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> mopas.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> mopas.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.json()["status"]["code"] == 20000:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> u.icq.net "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> u.icq.net "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.json()["Success"] == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> boyner.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> boyner.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 201:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> watsons.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> watsons.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.status_code) == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> app.buyursungelsin.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> app.buyursungelsin.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> osmgck.idealdata.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> osmgck.idealdata.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.text == "true":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> pinarsumobileservice.yasar.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> pinarsumobileservice.yasar.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.json()["code"] == "common.success":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> suiste.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> suiste.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["IsSuccessful"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> hayatsu.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> hayatsu.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.json()["ok"] == "1":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> api.pisir.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> api.pisir.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["isSucceed"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> apigw.ikinciyeni.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> apigw.ikinciyeni.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.status_code) == 201:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> api.terrapizza.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> api.terrapizza.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["phoneNumber"]) == str(numara):
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> ipapp.ipragaz.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> ipapp.ipragaz.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["messageCode"]) == "OK":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> mogazmobilapinew.aygaz.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> mogazmobilapinew.aygaz.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["data"]["success"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> gomobilapp.ipragaz.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> gomobilapp.ipragaz.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 204:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> mobilapi.petrolofisi.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> mobilapi.petrolofisi.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["success"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> mobileapi.totalistasyonlari.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> mobileapi.totalistasyonlari.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.status_code) == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> api.opet.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> api.opet.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> api-gateway.dolap.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> api-gateway.dolap.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["IsSuccess"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> heyapi.heymobility.tech "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> heyapi.heymobility.tech "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["kod"]) == "0000":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> mobileapiv2.tazi.tech "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> mobileapiv2.tazi.tech "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["sonuc"]["aciklama"]) == "İşlem Başarılı":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> app.isbike.istanbul "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> app.isbike.istanbul "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["isSuccess"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> mobileapi.n11.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> mobileapi.n11.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["success"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> joker.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> joker.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.json()["status"] == "SUCCESS":
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> api2.e-bebek.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> api2.e-bebek.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["status"]) == 1 :
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> mobilcrm2.saka.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> mobilcrm2.saka.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["success"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> backend.gofody.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> backend.gofody.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.status_code) == 202:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> madamecoco.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> madamecoco.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> bilet.balikesiruludag.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> bilet.balikesiruludag.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if r.status_code == 202:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> evidea.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> evidea.com "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.json()["status"]) == True:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> occ2.koctas.com.tr "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> occ2.koctas.com.tr "+Fore.LIGHTRED_EX+numara)
            ...
            if numara != "bos":
                ...
                try:
                    ...
                    if (r.status_code) == 200:
                        ...
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! --> ivt.mobildev.com "+Fore.LIGHTGREEN_EX+numara+Style.RESET_ALL+" Toplam gönderilen SMS: "+Fore.LIGHTGREEN_EX+ str(self.toplam_sms))
                    ...
                    print(f"{Fore.RED}[-] {Style.RESET_ALL}Gönderilemedi! --> ivt.mobildev.com "+Fore.LIGHTRED_EX+numara)
